...
x0_file='/Users/bgreenbe/Github/isofit-jax/files/algebraic_rfl'
atm_file='/Users/bgreenbe/Github/isofit-jax/files/heuristic_atm'
out_file='/Users/bgreenbe/Github/isofit-jax/files/oe_rfl'
batchsize=200

python cli_inversion.py oe $config_file $lut_file $rdn_file $obs_file \
                        $loc_file $x0_file $atm_file $out_file \
                        --batchsize $batchsize
